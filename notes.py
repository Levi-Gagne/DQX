So i have questions about the folloinwg fileswhcih are teh same but differnt versions


So i ask that you tell me the differnce between the two code blocks


call this first one the code_1:
import os
import json
import hashlib
import yaml
