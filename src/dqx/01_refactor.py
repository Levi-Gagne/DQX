So now the next thing is this

the primary key was not added, 
...
SHouldnt we have somthing like a sql command? spark.sql"""APPLY PRIMARY KEY ...


Can you show me the updated table.py:
# src/utils/table.py
