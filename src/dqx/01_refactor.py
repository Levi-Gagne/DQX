So this is another util file i have: 
...
So without changing the file above can we use the file above to replace this function in the notebook:
...
Here is the notebook code, can you show me full updated edition: 
import json
import hashlib
import yaml
